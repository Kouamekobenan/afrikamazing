          ...
          <div className="lg:col-span-2 space-y-2 sm:space-y-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300">
